...
${OBJECTDIR}/common/encoding.o: common/encoding.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/encoding.o common/encoding.c

${OBJECTDIR}/common/hashing.o: common/hashing.c 
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/hashing.o common/hashing.c

${OBJECTDIR}/common/kadmin/kadmin_common.o: common/kadmin/kadmin_common.c 
	${MKDIR} -p ${OBJECTDIR}/common/kadmin
	${RM} "$@.d"
	$(COMPILE.c) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/kadmin/kadmin_common.o common/kadmin/kadmin_common.c

${OBJECTDIR}/common/kdc/kdc_common.o: common/kdc/kdc_common.c 
	${MKDIR} -p ${OBJECTDIR}/common/kdc
	${RM} "$@.d"
	$(COMPILE.c) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/kdc/kdc_common.o common/kdc/kdc_common.c

${OBJECTDIR}/common/user/user_common.o: common/user/user_common.c 
	${MKDIR} -p ${OBJECTDIR}/common/user
	${RM} "$@.d"
	$(COMPILE.c) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/user/user_common.o common/user/user_common.c

${OBJECTDIR}/common/utils.o: common/utils.c 
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.c) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/utils.o common/utils.c
...
${OBJECTDIR}/fnasso.o: fnasso.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fnasso.o fnasso.c

${OBJECTDIR}/interfaces/ikadmin.o: interfaces/ikadmin.c 
	${MKDIR} -p ${OBJECTDIR}/interfaces
	${RM} "$@.d"
	$(COMPILE.c) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfaces/ikadmin.o interfaces/ikadmin.c

${OBJECTDIR}/interfaces/ikdc.o: interfaces/ikdc.c 
	${MKDIR} -p ${OBJECTDIR}/interfaces
	${RM} "$@.d"
	$(COMPILE.c) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfaces/ikdc.o interfaces/ikdc.c

${OBJECTDIR}/interfaces/iuser.o: interfaces/iuser.c 
	${MKDIR} -p ${OBJECTDIR}/interfaces
	${RM} "$@.d"
	$(COMPILE.c) -O3 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfaces/iuser.o interfaces/iuser.c
...
${TESTDIR}/tests/encoding.o: tests/encoding.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O3 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/encoding.o tests/encoding.c


${TESTDIR}/tests/hashing.o: tests/hashing.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O3 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/hashing.o tests/hashing.c


${TESTDIR}/tests/kadmin.o: tests/kadmin.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O3 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/kadmin.o tests/kadmin.c


${TESTDIR}/tests/kdc.o: tests/kdc.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O3 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/kdc.o tests/kdc.c


${TESTDIR}/tests/main.o: tests/main.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O3 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/main.o tests/main.c


${TESTDIR}/tests/user.o: tests/user.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O3 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/user.o tests/user.c


${TESTDIR}/tests/utils.o: tests/utils.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O3 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/utils.o tests/utils.c
...
${OBJECTDIR}/common/encoding_nomain.o: ${OBJECTDIR}/common/encoding.o common/encoding.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/encoding_nomain.o common/encoding.c;\
	else  \
...
${OBJECTDIR}/common/hashing_nomain.o: ${OBJECTDIR}/common/hashing.o common/hashing.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/hashing_nomain.o common/hashing.c;\
	else  \
...
${OBJECTDIR}/common/kadmin/kadmin_common_nomain.o: ${OBJECTDIR}/common/kadmin/kadmin_common.o common/kadmin/kadmin_common.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/kadmin/kadmin_common_nomain.o common/kadmin/kadmin_common.c;\
	else  \
...
${OBJECTDIR}/common/kdc/kdc_common_nomain.o: ${OBJECTDIR}/common/kdc/kdc_common.o common/kdc/kdc_common.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/kdc/kdc_common_nomain.o common/kdc/kdc_common.c;\
	else  \
...
${OBJECTDIR}/common/user/user_common_nomain.o: ${OBJECTDIR}/common/user/user_common.o common/user/user_common.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/user/user_common_nomain.o common/user/user_common.c;\
	else  \
...
${OBJECTDIR}/common/utils_nomain.o: ${OBJECTDIR}/common/utils.o common/utils.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/utils_nomain.o common/utils.c;\
	else  \
...
${OBJECTDIR}/debug_nomain.o: ${OBJECTDIR}/debug.o debug.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/debug_nomain.o debug.c;\
	else  \
...
${OBJECTDIR}/fnasso_nomain.o: ${OBJECTDIR}/fnasso.o fnasso.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fnasso_nomain.o fnasso.c;\
	else  \
...
${OBJECTDIR}/interfaces/ikadmin_nomain.o: ${OBJECTDIR}/interfaces/ikadmin.o interfaces/ikadmin.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfaces/ikadmin_nomain.o interfaces/ikadmin.c;\
	else  \
...
${OBJECTDIR}/interfaces/ikdc_nomain.o: ${OBJECTDIR}/interfaces/ikdc.o interfaces/ikdc.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfaces/ikdc_nomain.o interfaces/ikdc.c;\
	else  \
...
${OBJECTDIR}/interfaces/iuser_nomain.o: ${OBJECTDIR}/interfaces/iuser.o interfaces/iuser.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfaces/iuser_nomain.o interfaces/iuser.c;\
	else  \
